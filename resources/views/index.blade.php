...
<head>
	...
	<meta property="og:image" content="{{ asset('img/logo2-resized.jpg') }}">
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-white py-1 sticky-top">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"><img src="{{ asset('img/logo2-resized.jpg') }}" alt="TurboStaff logo"></a>
	...
	<div id="who-we-are" class="who-we-are section container-fluid bg-primary">
			...
			<div class="container-md mission text-center">
				<div class="row justify-content-around mb-4 g-5">
					<div class="col-sm-4">
						...
						<p class="text-dark">To become the most economical messenger service provider that is fast, efficient and reliable.</p>
					</div>
					<div class="col-sm-4">
		...
		<div id="what-we-offer" class="what-we-offer section container-fluid bg-secondary">
			...
			<div class="row offers my-5 justify-content-center gy-5">
				<div class="col-sm-5 text-center px-5">
					<img src="{{ asset('img/sc1.png') }}" class="img-fluid" alt="Payment / Transactions" loading="lazy">
				...
				<div class="col-sm-5 text-center px-5">
					<img src="{{ asset('img/sc2.png') }}" class="img-fluid" alt="Printer" loading="lazy">
				...
				<div class="col-sm-5 text-center px-5">
					<img src="{{ asset('img/briefcase.png') }}" class="img-fluid" alt="Briefcase" loading="lazy">
				...
				<div class="col-sm-5 text-center px-5">
					<img src="{{ asset('img/fast-delivery.jpg') }}" class="img-fluid" alt="Fast Delivery Nationwide!" loading="lazy">
			...
			<div class="container mt-5 pt-5">
				<img src="{{ asset('img/collage.jpg') }}" class="img-fluid" alt="TurboStaff Services in Baguio, Iloilo, and Cebu" loading="lazy">
		...
		<img class="group" src="{{ asset('img/group-photo-resized.jpg') }}" alt="Turbostaff Employees" loading="lazy">
		...
		<div id="contact" class="contact-us container-fluid">
			<div class="row justify-content-center mb-4">
				<div class="col-lg-7">
					...
					<p class="text-center text-secondary">Let us show you what our team of professionals can do for you and your business.</p>
				</div>
			</div>
			<div class="container mt-5">
				<div class="row justify-content-between">
					...
					<img src="{{ asset('img/motorcycle2-resized.jpg') }}" class="img-fluid" alt="Turbostaff Employees" loading="lazy">
				</div>
			</div>
		</div>
